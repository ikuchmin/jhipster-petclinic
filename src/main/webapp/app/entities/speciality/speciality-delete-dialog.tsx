...
import { getEntity, deleteEntity } from './speciality.reducer';
...
export const SpecialityDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="petClinicApp.speciality.delete.question">
        <Translate contentKey="petClinicApp.speciality.delete.question" interpolate={{ id: specialityEntity.id }}>
