...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPECIALITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPECIALITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPECIALITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPECIALITY actions', async () => {
      const arg = 42666;
